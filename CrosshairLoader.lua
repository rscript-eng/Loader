--!strict
--[[ Sleepy Crosshair Enterprise (Expert Compact Fixed Text Edition) - Fluid 10,000 FPS ]]
...
Watermark.Font = Enum.Font.Code -- Fuente tipo programador/minimalista limpia
Watermark.TextSize = 13
Watermark.Size = UDim2.fromOffset(100, 20)
Watermark.AnchorPoint = Vector2.new(0.5, 0) -- Centrado horizontalmente, alineado al borde superior del texto
Watermark.BackgroundTransparency = 1
Watermark.ZIndex = 12

-- Borde negro fino nativo para máxima legibilidad
...
-- El texto va dentro de ScreenGui para que herede la posición pero ignore la rotación
...
Connection = RunService.PreRender:Connect(function(dt)
    ...
    -- Interpolación de Posición Exponencial (Suavizado 10,000 FPS para eliminar stuttering)
    ...
    -- Cinemática de Rotación y Pulso de Tamaño
    ...
    -- Renderizador de Transformación Vectorial Unificado O(1)
    ...
    -- MODIFICACIÓN MARGEN MÍNIMO: Alineación ultra pegada al límite exterior absoluto (Gap + LengthMax)
    local MaxLineLength = CFG.Length + CFG.SizeRng
    local FixedBottomOffset = CFG.Gap + MaxLineLength
    local TextPosY = SmoothPos.Y + FixedBottomOffset + 1 -- Reducido de +6 a +1 píxel para máxima cercanía sin superposición
